                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <select class="form-select text-center bg-light border-0 border-bottom" id="category" onchange="load_brand();">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <select class="form-select text-center bg-light border-0 border-bottom" id="brand" onchange="load_model();">
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.svg" class="img-fluid" style="width: 250px;height: 250px;" id="i0" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.svg" class="img-fluid" style="width: 250px;height: 250px;" id="i1" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.svg" class="img-fluid" style="width: 250px;height: 250px;" id="i2" />
                                                </div>
                                            </div>
                                        </div>
