                    ...
                    <div class="row">
                        <div class="col-12 border border-1 border-primary rounded mb-2">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <label class="form-label fs-1 fw-bolder">Recents</label>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="offset-lg-2 col-12 col-lg-6 mb-3">
                                            <input type="text" class="form-control" placeholder="Search in Recents..." id="recents_search_txt" />
                                        </div>
                                        <div class="col-12 col-lg-2 mb-3 d-grid">
                                            <button class="btn btn-primary" onclick="recentsSearch(0);">Search</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-11 col-lg-2 border-0 border-end border-1 border-primary">
                                    ...
                                    <nav class="nav nav-pills flex-column">
                                        <a class="nav-link" aria-current="page" href="watchlist.php">My Watchlist</a>
                                        <a class="nav-link" href="#">My Cart</a>
                                        <a class="nav-link active" href="watchlist.php">Recents</a>
                                    </nav>
                                ...
                                $recent_rs = Database::search("SELECT * FROM `recent` WHERE `user_email`='" . $user . "'");
                                    ...
                                    <div class="col-12 col-lg-9">
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-center">
                                                <label class="form-label fs-1 fw-bold">You have no items in your recent yet.</label>
                                            </div>
                                ...
                                ?>
                                    ...
                                    <!-- have Products -->
                                    <div class="col-12 col-lg-9">
                                        <div class="row" id="recentsSearchResult">
                                            ...
                                            $selected_rs = Database::search("SELECT * FROM `recent` WHERE `user_email`='" . $user . "' LIMIT " . $results_per_page . " OFFSET " . $page_results . " ");
