                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr style="height: 72px;">
                                        <td class="bg-primary text-white fs-3">0<?php echo $invoice_data["id"]; ?></td>
                                        <td>
                                        ...
                                        <td class="fw-bold fs-6 text-end pt-4">0<?php echo $invoice_data["qty"]; ?></td>
                                        <td class="fw-bold fs-6 text-end pt-4 bg-secondary text-white">Rs. <?php echo ($product_data["price"]*$invoice_data["qty"]); ?>. 00</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">Rs. <?php echo $s; ?> .00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="border-0"></td>
